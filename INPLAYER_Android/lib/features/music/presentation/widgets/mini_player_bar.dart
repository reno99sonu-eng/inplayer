...
class MiniPlayerBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final coverUrl = isAd
        ? ad!.imageUrl
        : (track.covers.isNotEmpty ? track.covers.first : track.thumbnail);
        ...
        child: BackdropFilter(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: (isAd ? Colors.amber : AppColors.brandOrange).withValues(alpha: isDark ? 0.18 : 0.10),
                  blurRadius: 24,
                    ...
                    builder: (context, snapshot) {
                      ...
                      return SizedBox(
                        ...
                        child: LinearProgressIndicator(
                          value: isAd ? (1 - (player.adCountdown / 10.0)).clamp(0.0, 1.0) : ratio,
                          minHeight: 2,
                            ...
                            child: coverUrl.isNotEmpty
                                ? SafeAppImage(
                                    ...
                                    errorWidget: (context, url, error) => Container(
                                      color: (isAd ? Colors.amber : AppColors.music).withValues(alpha: 0.25),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                isAd
                                    ? (ad!.title.isNotEmpty ? ad.title : 'Sponsored Break')
                                    : (track.title.isEmpty ? 'Untitled track' : track.title),
                                maxLines: 1,
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
                                  color: isAd ? Colors.amber : context.textPrimary,
                                  fontSize: 13,
                              ...
                              Text(
                                ...
                                overflow: TextOverflow.ellipsis,
                                style: TextStyle(
                                  color: isAd ? Colors.white70 : context.textSecondary,
                                  fontSize: 11,
                                ),
                              ),
                            ],
                        ...
                        if (isAd) ...[
                          TextButton(
                            style: TextButton.styleFrom(
                              backgroundColor: player.skipUnlocked ? Colors.white : Colors.white12,
                            ...
                            child: Text(
                              player.skipUnlocked ? 'Skip →' : '${player.adCountdown}s',
