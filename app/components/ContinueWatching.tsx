    ...
    <section className="relative overflow-hidden bg-[#030712] px-6 pb-16">
      ...
      <div className="relative z-10 mx-auto max-w-[1600px]">
        ...
        <div className="mb-8 flex items-end justify-between">
          ...
          <button className="text-sm font-semibold text-orange-400 transition duration-300 hover:text-orange-300 hover:translate-x-1">
            View All →
          </button>
          ...
          {continueWatching.map((movie, index) => (
            ...
            >
              ...
              <div className="mt-4 h-1.5 overflow-hidden rounded-full bg-slate-700">
                ...
                <div
                  className="h-full rounded-full bg-gradient-to-r from-orange-500 via-orange-400 to-orange-300 transition-all duration-500"
                  style={{
