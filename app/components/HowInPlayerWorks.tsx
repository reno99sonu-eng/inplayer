  ...
  const steps: { icon: ReactNode; title: string; body: string }[] = [
    {
      ...
      body: `Upload videos and Shorts and build an audience. Once you cross ${ELIGIBILITY_THRESHOLD.subscribers} In-Family members and ${ELIGIBILITY_THRESHOLD.views.toLocaleString()} total views (videos + Shorts combined), monetization unlocks automatically on Your Channel.`,
    },
    {
