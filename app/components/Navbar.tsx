...
<div
  ...
  style={{
    backgroundImage:
      "radial-gradient(circle at 24px 24px, rgba(255,176,59,.35) 2px, transparent 2px)",
    backgroundSize: "36px 36px",
  }}
/>

<div className="pointer-events-none absolute left-1/2 top-0 h-28 w-[700px] -translate-x-1/2 bg-orange-500/10 blur-[120px]" />
