...
//
// Note: this stays INPLAYER-branded on every route including /shop. The
// Hammart storefront has its own header bar with its own Ham Mart lockup
// (see app/shop/page.tsx) — branding both would stack two Ham Mart logos
// on the same screen.
