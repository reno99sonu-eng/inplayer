...
export default function TrendingNow() {
  ...
  useEffect(() => {
    ...
    el.addEventListener("wheel", pauseUser, { passive: true });
    el.addEventListener("touchstart", pauseUser, { passive: true });
    el.addEventListener("pointerdown", pauseUser);
    ...
    return () => {
      ...
      el.removeEventListener("wheel", pauseUser);
      el.removeEventListener("touchstart", pauseUser);
      el.removeEventListener("pointerdown", pauseUser);
    };
  }, [shouldAnimate]);
