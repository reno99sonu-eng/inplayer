...
const inplayerItems = [
  ...
  { id: "stuck-processing", label: "Stuck Uploads", href: "/admin/stuck-processing", permission: "delete_stuck_processing_videos" },
  { id: "reports", label: "Reports", href: "/admin/moderation", permission: "view_reports" },
