...
export const CHAT_THEMES: Record<string, ChatTheme> = {
  ...
  emeraldLight: {
    ...
    containerClass: "light bg-[#EFEAE2] text-slate-900",
  ...
  blossom: {
    id: "blossom",
    name: "Soft Blossom",
    previewBg: "bg-pink-50 border-pink-300",
    containerClass: "light bg-pink-50 text-slate-900",
    bubbleMine: "bg-pink-200 text-slate-900 shadow-sm border border-pink-300/50",
    bubbleOther: "bg-white/95 backdrop-blur-md text-slate-900 shadow-sm border border-pink-100",
    texturePattern: WHATSAPP_DOODLE_TEXTURE,
  ...
  ocean: {
    ...
    containerClass: "light bg-sky-50 text-slate-900",
    bubbleMine: "bg-sky-200 text-slate-900 shadow-sm border border-sky-300/50",
    bubbleOther: "bg-white/95 backdrop-blur-md text-slate-900 shadow-sm border border-sky-100",
    texturePattern: WHATSAPP_DOODLE_TEXTURE,
  ...
  pearl: {
    ...
    containerClass: "light bg-slate-50 text-slate-900",
    bubbleMine: "bg-slate-200 text-slate-900 shadow-sm border border-slate-300/50",
    bubbleOther: "bg-white/95 backdrop-blur-md text-slate-900 shadow-sm border border-slate-200",
    texturePattern: WHATSAPP_DOODLE_TEXTURE,
  ...
  lavender: {
    id: "lavender",
    name: "Lavender Mist",
    previewBg: "bg-fuchsia-50 border-fuchsia-300",
    containerClass: "light bg-fuchsia-50 text-slate-900",
    bubbleMine: "bg-fuchsia-200 text-slate-900 shadow-sm border border-fuchsia-300/50",
    bubbleOther: "bg-white/95 backdrop-blur-md text-slate-900 shadow-sm border border-fuchsia-100",
    texturePattern: STARDUST_TEXTURE,
