...
// Real, InPlayer-specific Privacy Policy — see the note that used to sit
// in app/privacy/page.tsx (now a redirect into this hub): this reflects
// how InPlayer actually collects and uses data today, but is a working
// draft, not a substitute for legal review before this goes live to real
// users (especially given InPlayer allows signups from age 13+).
export default function PrivacyPolicySection() {
  return (
    <>
      ...
      <PolicySection title="2. How we use it">
        <ul className="list-disc space-y-1.5 pl-5">
      ...
      <PolicySection title="3. Automated moderation">
        <p>
      ...
      <PolicySection title="4. Who we share data with">
        ...
        <p>
          ...
          <Link href="/policies?tab=terms" className="text-orange-400 hover:underline">
            Terms of Service
          </Link>
          .
        </p>
      ...
      <PolicySection title="5. Cookies &amp; Third-Party Advertising (Google AdSense)">
        <p>
      ...
      <PolicySection title="8. Your rights &amp; grievance officer">
        <p>
