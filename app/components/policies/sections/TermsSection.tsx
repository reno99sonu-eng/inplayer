...
// actually link to (via /terms, which now redirects into this hub),
// replacing a blind Accept/Reject with nothing to read. IMPORTANT: this is
// a working draft written to match how InPlayer actually functions today
// (13+ age gate, real AI moderation, real report system, etc.) — it is not
// a substitute for review by a lawyer familiar with Indian IT Rules /
// consumer protection law before this goes live to real users.
export default function TermsSection() {
  return (
    <>
      ...
      <PolicySection title="1. Who can use InPlayer">
        <p>
      ...
      <PolicySection title="2. Your account">
        ...
        <p>
          ...
          <Link href="/policies?tab=privacy" className="text-orange-400 hover:underline">
            Privacy Policy
          </Link>{" "}
      ...
      <PolicySection title="4. Copyright (DMCA-style takedowns)">
        <p>
      ...
      <PolicySection title="5. Buying and selling on HamMart">
        <p>
        ...
        <p>
          ...
          <Link href="/policies?tab=vendor-terms" className="text-orange-400 hover:underline">
      ...
      <PolicySection title="6. Suspension and removal">
        <p>
      ...
      <PolicySection title="8. Grievance Officer">
        <p>
