...
export const VENDOR_TERMS_LAST_UPDATED = "11 August 2026";
...
// keep vendor-facing language simple. Same honest caveat as TermsSection:
// this is a working draft matching the real product, not a substitute for
// review by a lawyer familiar with Indian consumer-protection and IT law
// before this is relied on for compliance at scale.
export default function VendorTermsSection() {
  return (
    <>
      <PolicySection title="1. What Hammart is">
        <p>
      ...
      <PolicySection title="2. Becoming a verified vendor">
        <p>
      ...
      <PolicySection title="3. Accurate, honest listings — Rule 6, Consumer Protection (E-Commerce) Rules 2020">
      ...
      <PolicySection title="4. Payment — two ways to get paid, your choice">
        <p>
      ...
      <PolicySection title="5. Returns, refunds, and cancellations">
        <p>
      ...
      <PolicySection title="6. Banned items">
        <p>
      ...
      <PolicySection title="7. Grievance handling">
        <p>
          ...
          Grievance Officer for Hammart-related complaints can be reached through the contact details listed in our{" "}
          <Link href="/policies?tab=terms" className="font-semibold text-orange-300 hover:underline">
      ...
      <PolicySection title="8. Fees & Listing Charges">
        <p>
      ...
      <PolicySection title="9. Suspension and removal">
        <p>
      ...
      <PolicySection title="10. Taxes and legal compliance">
        <p>
      ...
      <PolicySection title="11. Data and privacy">
        <p>
          ...
          <Link href="/policies?tab=privacy" className="font-semibold text-orange-300 hover:underline">
            Privacy Policy
          </Link>{" "}
