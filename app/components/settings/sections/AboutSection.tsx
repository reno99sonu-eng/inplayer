  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="mt-5 flex items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.03] px-5 py-4">
          <Sparkles size={18} className="text-orange-300" />
          <div>
            <p className="text-sm font-bold text-white">InPlayer</p>
            <p className="text-xs text-slate-500">Version 0.1.0 · Beta</p>
          </div>
        </div>
      </SettingsCard>
